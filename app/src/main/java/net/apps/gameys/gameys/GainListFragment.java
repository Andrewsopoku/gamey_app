...
public class GainListFragment extends Fragment {
    ...
    public void getDepolist(){
        ...
        String url = SAppUtil.baseurl+"/gain-list";
        Log.d("Url",url);
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            if( detail.getString("status").toString().equals("ok")){
                                totaldepo.setText(detail.getString("gain_total"));
                                JSONArray depolist = new JSONArray();

                                depolist=detail.getJSONArray("gain");
