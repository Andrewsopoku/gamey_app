...
public class LoseListFragment extends Fragment {
    ...
    public void getDepolist(){
        ...
        String url = SAppUtil.baseurl+"/lose-list";
        Log.d("Url",url);
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            if( detail.getString("status").toString().equals("ok")){
                                totaldepo.setText(detail.getString("lose_total"));
                                JSONArray depolist = new JSONArray();

                                depolist=detail.getJSONArray("lose");
